...
1. **→ [1. Introduction](./introduction)** - Evolution from GPT to current models
2. **→ [2. Tokenization](./tokenization)** - Understanding text processing
3. **→ [3. Embeddings](./embeddings)** - Semantic vector representations
4. **→ [4. Transformer Architecture](./transformer-architecture)** - Model internals
5. **→ [5. Inference](./inference)** - Generating outputs
6. **→ [6. Training Pipeline](./training-pipeline)** - How models learn
7. **→ [7. Cognitive Limitations](./limitations)** - Working with constraints

---

:::tip Start Here
New to LLMs? Begin with **[Introduction](./introduction)** to understand the evolution and core concepts before diving into technical details.
:::
