...
**1. [RAG Foundation](/docs/ai/rag/introduction)** - Start Here
...
**2. [Data Processing Pipeline](/docs/ai/rag/data-processing)**
...
**3. [Vector Indexing & Storage](/docs/ai/rag/vector-indexing)**
...
**4. [Retrieval Strategies](/docs/ai/rag/retrieval)**
...
**5. [Generation Strategies](/docs/ai/rag/generation)**
...
**6. [Evaluation Strategies](/docs/ai/rag/evaluation)**
...
**7. [Advanced RAG Techniques](/docs/ai/rag/advanced-rag)**
...
**8. [Production Engineering](/docs/ai/rag/production)**
...
**9. [Best Practices](/docs/ai/rag/best-practices)**
...
- **Rapid Prototyping**: Start with [Chapter 2](/docs/ai/rag/data-processing) and use off-the-shelf document loaders
- **Deep Understanding**: Start with [Chapter 1](/docs/ai/rag/introduction) and learn theoretical foundations
- **Production-Ready**: Jump to [Chapter 8](/docs/ai/rag/production) and [Chapter 9](/docs/ai/rag/best-practices)
