...
|-------|-------------------|------|
| **OpenAI Codex (GPT-5.5)** | ~59% | Cloud API |
| **Claude Code** | ~45% | CLI Agent |
| **OpenAI Codex (GPT-5.4)** | ~48% | Cloud API |
| **Devin** | ~40% | Autonomous |
...
SWE-bench scores improve rapidly. GPT-5.5 (April 23, 2026) achieved 58.6% on SWE-Bench Pro and 82.7% on Terminal-Bench 2.0, setting new SOTA for agentic coding. The numbers above represent approximate snapshots — check the [official leaderboard](https://www.swebench.com/) for current results.
:::
