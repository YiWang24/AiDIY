...
> "Recent strong models already exhibit strong reasoning capabilities under the Zero-shot CoT setting, and the primary role of Few-shot CoT exemplars is to align the output format." — EMNLP 2024 Findings
...
**Recent research (NeurIPS 2024)** shows CoT can reduce performance in specific scenarios:
