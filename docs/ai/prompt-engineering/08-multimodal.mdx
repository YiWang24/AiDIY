...
| Feature | **GPT-4o** | **Claude 3.7 Sonnet** | **Gemini 2.0** |
|---------|------------|--------------|----------------|
...
│   │          │          │              │               │               │
│   ▼          ▼          ▼              ▼               ▼               │
│ Any       Claude 3.7   Gemini 2.0   GPT-4o/      Gemini 2.0             │
│ Model     (PDF native) (native)   Gemini       (best cross-           │
│           GPT-4o                              modal)                   │
│           Gemini                                                       │
│                                                                         │
│   For OCR/extraction: Claude 3.7 > Gemini > GPT-4o                       │
...
**Next**: [3.3 Agent Orchestration](./09-agent-orchestration.mdx) →
