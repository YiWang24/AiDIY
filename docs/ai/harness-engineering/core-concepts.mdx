...
**Grow the Harness, Not the Context（arXiv 2609.26760）**：提出从"无策略脚手架"（strategy-free scaffolds）演化出可复用专家 Agent 的路线——与其无限扩大上下文窗口，不如让 harness 在任务族上生长沉淀。这是对第一章"agent boundaries"的呼应：**上下文不是免费资源**，专家能力应沉淀在 harness 结构里而非塞进上下文。同期 2609.26704（*Beyond Repeated Sampling*）训练显式搜索策略替代"重复采样再选优"，同样是把"计算换质量"的模式固化为结构。

> 来源：[arXiv:2609.26760](https://arxiv.org/abs/2609.26760)、[arXiv:2609.26704](https://arxiv.org/abs/2609.26704)（2026-09-22）
