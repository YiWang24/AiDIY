...
sidebar_label: 4. 检索
description: 向量搜索、查询变换、路由和重排序技术
...
**Next Steps**:
- 📖 Read [RAG Fundamentals](/docs/ai/rag/introduction) for vector space mathematics
- 📖 Read [Data Processing](/docs/ai/rag/data-processing) for document indexing strategies
- 💻 Implement hybrid retrieval: Start with vector + keyword, add reranker
- 🔧 Experiment with query translation techniques on your specific use cases
