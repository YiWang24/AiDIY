...
sidebar_label: 5. 生成
description: Prompt Engineering、上下文组装、生成控制和 RAG 系统高级模式
...
**Next Steps**:
- 📖 Read [Retrieval Strategies](/docs/ai/rag/retrieval) for retrieval optimization
- 📖 Read [Data Processing](/docs/ai/rag/data-processing) for indexing strategies
