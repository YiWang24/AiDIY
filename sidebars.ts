      ...
      items: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              type: "doc",
              id: "cs/network-os/troubleshooting/dns-issues",
              label: "DNS Issues",
            },
            {
              type: "doc",
              id: "cs/network-os/troubleshooting/tcp-issues",
              label: "TCP Issues",
            },
            {
              type: "doc",
              id: "cs/network-os/troubleshooting/mtu-issues",
              label: "MTU Issues",
            },
            {
              type: "doc",
              id: "cs/network-os/troubleshooting/tls-issues",
              label: "TLS Issues",
            },
          ],
        },
      ...
      items: [
        {
          ...
          label: "Overview",
          key: "ai-spring-ai-overview",
        },
        {
          type: "doc",
          id: "ai/spring-ai/providers",
          label: "Providers",
        },
        {
          type: "doc",
          id: "ai/spring-ai/advisors",
          label: "Advisors",
        },
        {
          type: "doc",
          id: "ai/spring-ai/observability",
          label: "Observability",
        },
        {
          type: "doc",
          id: "ai/spring-ai/testing",
          label: "Testing",
        },
        {
          type: "doc",
          id: "ai/spring-ai/production",
          label: "Production",
        },
      ],
    },
  ...
  engineeringSidebar: [
    ...
    },
    {
      ...
      items: [
        ...
        { type: "doc", id: "engineering/backend/concurrency", label: "Concurrency Programming" },
        { type: "doc", id: "engineering/backend/database", label: "Database" },
        { type: "doc", id: "engineering/backend/caching", label: "Caching" },
        { type: "doc", id: "engineering/backend/microservices", label: "Microservices" },
        { type: "doc", id: "engineering/backend/spring-security", label: "Spring Security" },
        { type: "doc", id: "engineering/backend/testing", label: "Testing", key: "eng-backend-testing" },
      ],
    },
    {
      type: "category",
      ...
      items: [
        ...
        { type: "doc", id: "engineering/frontend/performance", label: "Performance" },
        { type: "doc", id: "engineering/frontend/forms", label: "Forms" },
        { type: "doc", id: "engineering/frontend/auth", label: "Auth" },
        { type: "doc", id: "engineering/frontend/animation", label: "Animation" },
        { type: "doc", id: "engineering/frontend/testing", label: "Testing", key: "eng-frontend-testing" },
      ],
    },
    {
      type: "category",
      ...
      items: [
        ...
        { type: "doc", id: "engineering/devops/docker-networking", label: "Docker Networking" },
        { type: "doc", id: "engineering/devops/k8s-rbac", label: "K8s RBAC" },
        { type: "doc", id: "engineering/devops/helm", label: "Helm" },
        { type: "doc", id: "engineering/devops/terraform", label: "Terraform" },
        { type: "doc", id: "engineering/devops/security", label: "DevSecOps" },
      ],
    },
    {
      type: "category",
      ...
      items: [
        ...
        { type: "doc", id: "engineering/tools/vscode", label: "VS Code" },
        { type: "doc", id: "engineering/tools/git-rebase", label: "Git Rebase" },
        { type: "doc", id: "engineering/tools/docker-dev", label: "Docker Dev" },
        { type: "doc", id: "engineering/tools/api-testing", label: "API Testing" },
        { type: "doc", id: "engineering/tools/productivity", label: "Productivity" },
      ],
    },
  ],
