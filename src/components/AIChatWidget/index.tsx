                    ...
                    if (line.startsWith('event:')) {
                        ...
                        try {
                            ...
                            if (eventType === 'retrieval_start') {
                                ...
                                fullContent += delta;
                                console.log('Generation delta:', delta, 'Full content so far:', fullContent);
                                setMessages(prev => prev.map(msg =>
                                    msg.id === assistantMessageId
                                ...
                                setMessages(prev => {
                                    ...
                                    console.log('Updated messages:', updated.map(m => ({ id: m.id, content: m.content?.substring(0, 50) })));
                                    return updated;
                                });
                ...
                <div className={styles.chatWindow}>
                    ...
                    <div className={styles.header}>
                        ...
                        <div className={styles.headerActions}>
                            ...
                            <button className={styles.closeButton} onClick={() => setIsOpen(false)} title="Close chat">
                    ...
                    <div className={styles.messages}>
                        ...
                        {messages.map((message) => {
                            console.log('Rendering message:', message.id, 'Role:', message.role, 'Content length:', message.content?.length, 'Content preview:', message.content?.substring(0, 50));
                            return (
                            <div
                                key={message.id}
                            ...
                            >
                                <div className={styles.messageContent}>
                                    {/* Retrieval Status */}
                                    {message.isStreaming && message.retrievalChunks && message.retrievalChunks.length > 0 && (
                                    ...
                                    {/* Performance Metrics */}
                                    {!message.isStreaming && (message.retrievalTimeMs || message.generationTimeMs) && (
