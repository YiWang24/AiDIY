...
### MCPEvol-Bench：动态演化的 MCP 服务器基准（arXiv:2607.14642）

MCPEvol-Bench 首次系统评估 LLM Agent 在 MCP（Model Context Protocol）服务器发生动态演化（接口变更、工具增删）时的适应能力，填补了"Agent 对工具变更鲁棒性"的评估空白——这是 MCP 生态走向生产环境必须解决的关键问题。
...
> 来源：[arXiv:2607.15257](https://arxiv.org/abs/2607.15257)；[arXiv:2607.15193](https://arxiv.org/abs/2607.15193)；[arXiv:2607.14642](https://arxiv.org/abs/2607.14642)；[arXiv:2607.14573](https://arxiv.org/abs/2607.14573)（2026-07）
...
- **AI Agents / 前沿趋势** (`docs/ai/agents/10-frontier.mdx`): 新增 10 条前沿趋势（#317-326），覆盖 Qwen 3.8 发布、OpenAI 缩减 Codex 上下文、Moonshot 暂停 Kimi K3 订阅、Claude Code 采用 Rust 版 Bun、英国 AISI 网络能力差距报告，以及 SearchOS-V1、Plover、MCPEvol-Bench、Alipay-PIBench、GenCeption 等学术与产业进展
